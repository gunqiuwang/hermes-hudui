...
export default function PatternsPanel() {
  ...
  return (
    <>
      <Panel title="任务集群" className="col-span-1">
      ...
      <Panel title="每小时活动" className="col-span-1">
        ...
        {data.peak_hour !== null && (
          <div className="mt-2 text-[13px]">
            高峰: <span style={{ color: 'var(--hud-primary)' }}>{String(data.peak_hour).padStart(2, '0')}:00</span>
          </div>
        )}
      </Panel>
